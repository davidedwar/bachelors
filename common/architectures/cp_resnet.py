...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, k1=3, k2=3):
        ...
        self.conv1 = nn.Conv2d(
            ...
            bias=False)
        print("batchhh basicblockkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk 111111")
        ...
        self.conv2 = nn.Conv2d(
            ...
            bias=False)
        print("batchhh basicblockkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk 2222222222222222")
...
class Network(nn.Module):
    def __init__(self, config):
        ...
        print("batchhh basicblockkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk 3333333")
        ...
        ff_list = []
        print("batchhh basicblockkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk 44444444444444444")
        ff_list += [nn.Conv2d(
            n_channels[2],
            n_classes,
            kernel_size=1,
