...
class DensityEstimate(pl.LightningModule):
    ...
    def configure_optimizers(self):
        print("optimizer in experiment density 7777777777777777777777777777777777777777777777777777777")
    ...
    def add_model_specific_args(parent_parser, **defaults):
        ...
        print("learning rate   zed in experiment densityyyy222222222222222222222222222222222222222")
