...
class ClassificationExperiment(pl.LightningModule):
    ...
    def __init__(
        ...
        if normalize in ['mean_std', 'mean_std_learnable']:
            ...
            print("normalizationnn in expclassificationnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn")
    ...
    def configure_optimizers(self):
        print("optimizer in exepereimente classification  999999999999999999999999999999999999999999")
        optimizer = torch.optim.Adam(
            self.parameters(),
            lr=self.kwargs['learninglearning_rate'],
    ...
    def add_model_specific_args(parent_parser, **defaults):
        ...
        print("learning rate from expperiment classification 11111111111111111111111111111111111111")
