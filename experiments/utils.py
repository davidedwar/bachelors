...
def get_experiment(**args):
    ...
    print("bob get_experiments utils.pyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy")
    if args['experiment'] == 'multi_section':
        print("first one in utilsssssssssssssssssssssssssssssssssssssssss")
        kwargs = {
                'task': 'multi_section',
                'batch_size': 16,
                'snippet_length': 10,
        ...
        print("second one in utilsssssssssssssssssssssssssssssssssssssssssssssss")
        kwargs = {
            'batch_size': 512,
